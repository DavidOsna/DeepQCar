...
ddqn_agent = DDQNAgent(alpha=0.0005, gamma=0.99, n_actions=4, epsilon=0.02, epsilon_end=0.01, epsilon_dec=0.999, replace_target=REPLACE_TARGET, batch_size=64, input_dims=10,fname='ddqn_model2.h5')
